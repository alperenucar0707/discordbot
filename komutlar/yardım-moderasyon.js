 ...
 **${prefix}everyone-engel** \n-> Everyone engeli ayarlar.
 **${prefix}yavaşmod** \n-> İstediğiniz süre kadar Slowmode ayarlar.
 **${prefix}warn** \n-> Etiketlediğiniz kişiyi uyarırsınız.
 **${prefix}uyarılar** \n-> Etiketlediğiniz kişinin uyarılarını gösterir.
 **${prefix}sohbet-kapat** \n-> Kanalın Chatını kapatır.
 **${prefix}sohbet-aç** \n-> Kanalın Chatını açar.
 **${prefix}uyarı-log #kanal** \n-> Uyarı Log kanalı seçersiniz.
 **${prefix}uyarı-sıfırla** \n-> Etiketlediğiniz kişinin uyarılarını sıfırlar.
`)
 .setTimestamp()
