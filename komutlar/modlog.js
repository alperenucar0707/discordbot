...
if (!logk) return message.channel.send(`<a:x:770187639801774080> Yanlış kullanım doğru kullanım: !mod-log #kanal`);

db.set(`log_${message.guild.id}`, logk.id)

message.channel.send(`<a:white_check_mark:770187690402250772> Mod-log kanalı başarıyla ${logk} olarak ayarlandı.`);
